...
public class EvtcParser
{
    ...
    private void ParseAgentData(BinaryReader reader, ParserController operation)
    {
        ...
        for (int i = 0; i < agentCount; i++)
        {
            ...
            //Save
            Spec agentProf = ProfHelper.ProfToSpec(GetAgentProfString(prof, isElite, operation)); //TODO(Rennorb) @perf: Drop the 3 wrappers around what we are actually doing here.
